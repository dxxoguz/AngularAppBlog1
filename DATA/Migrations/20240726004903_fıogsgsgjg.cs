...
{
    /// <inheritdoc />
    public partial class fıogsgsgjg : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Adding = table.Column<DateTime>(type: "datetime2", nullable: true),
                    District = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Customer_Inform = table.Column<bool>(type: "bit", nullable: false),
                    Customer_Allow = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Indictination", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Indictination_Users_UserDtoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Indictination_UserDtoId",
                table: "Indictination",
                column: "UserDtoId");
